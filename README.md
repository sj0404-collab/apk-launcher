...
- **Кнопки прямо поверх окна**: над каждым мини-приложением плавающий оверлей
  ...
  позицию (углы/стороны/центр), `✕` закрыть. Управляется тапом, так что жесты
...
- Мини-окна (`setLaunchBounds` + скрытый freeform-режим) раскрываются в
  ...
  freeform они мягко сводятся к обычному запуску окна. Android не даёт
